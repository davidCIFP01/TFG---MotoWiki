...
CREATE TABLE IF NOT EXISTS `registros` (
  ...
  CONSTRAINT `fk_registros_usuario` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `motocicleta` (
  ...
  `popularidad` INT ZEROFILL NOT NULL,
  `precioMin` FLOAT,
  `precioMax` FLOAT,
  ...
  CONSTRAINT `fk_motocicleta_fabricante` FOREIGN KEY (`idFabricante`) REFERENCES `fabricante` (`idFabricante`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `favoritas` (
  ...
  CONSTRAINT `fk_favoritas_usuario` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_favoritas_motocicleta` FOREIGN KEY (`idMoto`) REFERENCES `motocicleta` (`idMoto`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `noticias` (
  ...
  `idUsuario` INT NOT NULL,
  CONSTRAINT `fk_noticias_usuario` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ofertas` (
  ...
  `precio` FLOAT,
  `idMoto` INT NOT NULL,
  CONSTRAINT `fk_ofertas_motocicleta` FOREIGN KEY (`idMoto`) REFERENCES `motocicleta` (`idMoto`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
