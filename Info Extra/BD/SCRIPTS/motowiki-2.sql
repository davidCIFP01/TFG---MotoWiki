...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2024 a las 13:55:10
...
CREATE TABLE `fabricante` (
  ...
  `sitioWeb` varchar(500) DEFAULT NULL,
  `descripcion1` varchar(750) DEFAULT NULL,
  `descripcion2` varchar(750) DEFAULT NULL,
  `imagenFabricante` varchar(250) DEFAULT NULL,
...
(755, 'Brute Force 300', '2022', 'ATV', 271, 22, 16, 'Liquid', 'Single cylinder, four-stroke', 0, 'Shaft drive (cardan)   (final drive)', '12.00', 'Electric', NULL, NULL, 0, 2500, 10000, NULL, NULL, 0, 1, 1170, 243),
...
(1280, '300 XC-W TPI', '2021', 'Enduro / offroad', 293, NULL, NULL, 'Liquid', 'Single cylinder, two-stroke', 6, 'Chain   (final drive)', '9.00', 'Electric', NULL, NULL, 1, NULL, NULL, NULL, NULL, 0, 6, NULL, NULL),
...
(1405, 'YBR125 ED', '2022', 'Allround', 124, 10, 7, 'Air', 'Single cylinder, four-stroke', 5, 'Chain   (final drive)', '13.00', 'Electric', NULL, NULL, 0, NULL, NULL, NULL, '../view/assets/images/motocicleta/YBR125ED.jfif', 0, 3, 1080, 123),
...
(1423, 'YBR250', '2011', 'Sport', 249, 21, 15, 'Air', 'Single cylinder, four-stroke', 5, 'Chain   (final drive)', '19.20', 'Electric', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 3, 1065, 138),
...
(1435, 'Classic 350', '2022', 'Classic', 349, 20, 14, 'Oil & air', 'Single cylinder, four-stroke', 5, 'Chain   (final drive)', '13.00', 'Electric & kick', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 8, 1090, 195),
(1436, 'Continental GT 650', '2022', 'Classic', 648, 47, 34, 'Air', 'Twin, four-stroke', 6, 'Chain   (final drive)', '12.50', 'Electric', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 8, 1069, 212),
(1437, 'Himalayan', '2022', 'Enduro / offroad', 411, 25, 18, 'Air', 'Single cylinder, four-stroke', 5, 'Chain   (final drive)', '12.49', 'Electric', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 8, 1360, 194),
(1438, 'Interceptor 650', '2022', 'Classic', 648, 47, 34, 'Air', 'Twin, four-stroke', 6, 'Chain   (final drive)', '13.70', 'Electric', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 8, 1120, 217),
(1439, 'Meteor 350', '2022', 'Classic', 349, 20, 15, 'Oil & air', 'Single cylinder, four-stroke', 5, 'Chain   (final drive)', '15.00', 'Electric', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 8, 1140, 191),
...
(1482, 'Classic Battle Green ', '2017', 'Classic', 499, 27, 20, 'Air', 'Single cylinder, four-stroke', 5, 'Chain   (final drive)', '14.50', 'Electric & kick', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 8, 1050, 187),
...
(1509, 'Classic 500', '2015', 'Classic', 499, 27, 20, 'Air', 'Single cylinder, four-stroke', 5, 'Chain   (final drive)', '13.50', 'Electric & kick', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 8, 1080, 190),
...
(1521, 'Bullet Electra', '2014', 'Classic', 346, 20, 15, 'Air', 'Single cylinder, four-stroke', 5, 'Chain   (final drive)', '13.50', 'Electric & kick', NULL, NULL, 0, NULL, NULL, NULL, NULL, 0, 8, 1120, 187),
...
CREATE TABLE `noticias` (
  ...
  `entrada2` varchar(100) DEFAULT NULL,
  `entrada3` varchar(100) DEFAULT NULL,
...
CREATE TABLE `ofertas` (
  ...
  `enlaceOferta` varchar(150) DEFAULT NULL,
...
--
ALTER TABLE `registros`
  MODIFY `idRegistro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
